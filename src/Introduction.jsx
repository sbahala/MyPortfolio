    ...
    <section id="introduction" className="bg-white mx-auto max-w-8xl rounded-2xl p-8 flex flex-col md:flex-row items-center gap-10 transition-transform transform hover:scale-105">
      ...
      <div className="md:w-2/3 text-center md:text-left">
        ...
        <p className="text-gray-700 leading-relaxed">
          Hello! I'm a passionate Coder a deep love for coding and technology. I have hands-on experience with Java, Python, Scripting, React, Node, HTML, CSS, JavaScript. My goal is to learn everyday use my skill as a Full Stack Developer and explore AI and ML.
        </p>
